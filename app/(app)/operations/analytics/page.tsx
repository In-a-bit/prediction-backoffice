          ...
          return (
            ...
            >
              <div className="flex items-start gap-3">
                <span className={`mt-0.5 shrink-0 transition-colors ${active ? "text-accent" : "text-foreground-muted group-hover:text-foreground"}`}>
                  {d.icon}
                </span>
                <div className="min-w-0">
                  <p className={`text-sm font-semibold truncate ${active ? "text-accent" : "text-foreground"}`}>
                    {d.name}
                  </p>
